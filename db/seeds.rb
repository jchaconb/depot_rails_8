...
product.image.attach(io: Rails.root.join("db/images/image_1.png").open,
...
product.image.attach(io: Rails.root.join("db/images/image_2.png").open,
...
product.image.attach(io: Rails.root.join("db/images/image_3.png").open,
